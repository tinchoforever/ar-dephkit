...
THREE.TransformControls = function ( camera, domElement ) {
	...
	this.pointerHover = function( pointer ) {
		...
		if ( intersect ) {
			//console.log('yay! mosue is on something!');
	...
	this.pointerUp = function( pointer ) {
		...
		if ( this.dragging && ( this.axis !== null ) ) {
			...
			//Dragging event ends here for a transform of an object. 
			//This will emit transformChanged event attached to the a-scene. 
			//Event will be captured in the comps.js file. 
			document.querySelector('a-scene').emit('transformChagedByDrag');
		}
